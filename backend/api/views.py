    ...
    def post(self, request):
        ...
        if serialzer.is_valid():
           ...
           # check df is empty or not
            ...
            # Generate basic Plot
            plt.switch_backend('AGG')  #Anti-Grain Geometry - save the plot as an image instead of displaying it, image file store in media folder
            ...
            # save the plot to a file - MA 100 , dma - days moving average
            ...
            # Revert the scaled prices to original price (inverse transform from the scaler) 
